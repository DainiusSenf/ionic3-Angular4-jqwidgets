...
export class SalesforceService {
   ...
   */
		...
		let p: Promise<any> = new Promise((resolve, reject) => {
			if (this.useRest) {
				...
				if (beforeHookResult) {
                    ...
                    this._zone.runOutsideAngular(() => {
                        this.execute_vfr(controller, method, tmp, vfrOptions)
                                .then((res) => {
									console.log('Result: ', res);
	...
	private execute_vfr(controller: string, method: string, params: Array<any>, config?: RemotingOptions): Promise<any> {
